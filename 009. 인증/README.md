...
![1. Auth 디렉터리](../.dummy/10%20인증/1.%20Auth%20디렉터리.png)
...
![2. B Crypt Net Next](../.dummy/10%20인증/2.%20BCrypt%20Net%20Next.png)
...
![3. Jwt Bearer](../.dummy/10%20인증/3.%20JwtBearer.png)
...
![4. 메인페이지](../.dummy/10%20인증/4.%20메인페이지.png)

로그인을 안 하면 다음처럼 인증에 실패한다.  

![5. 이름 실패](../.dummy/10%20인증/5.%20이름%20실패.png)  
![6. 로그아웃 실패](../.dummy/10%20인증/6.%20로그아웃%20실패.png)

양식에 맞게 정보를 입력하면 회원가입에 성공한다.

![7. 회원가입 성공](../.dummy/10%20인증/7.%20회원가입%20성공.png)

실제 db에 접속해보면 패스워드 해싱까지 잘 된 것을 확인할 수 있다.

![8. 가입확인](../.dummy/10%20인증/8.%20가입확인.png)

회원가입한 정보대로 로그인하면 로그인에 성공한다.

![9. 로그인 성공](../.dummy/10%20인증/9.%20로그인%20성공.png)

로그인에 성공했기 때문에 다음과 같이 이름 확인이 가능하다.

![10. 이름 확인](../.dummy/10%20인증/10.%20이름%20확인.png)

로그아웃도 정상적으로 완료되었다.

![11. 로그아웃 성공](../.dummy/10%20인증/11.%20로그아웃%20성공.png)

로그아웃 이후 이름 확인을 시도하면 실패한다.

![12. 로그아웃 이후](../.dummy/10%20인증/12.%20로그아웃%20이후.png)
